...
function loadAdminImagesRealtime() {
  db.collection("admin").doc("images")
    .onSnapshot(doc => {
      ...
      // Se il doc non esiste, esci
      if (!doc.exists) return;

      const data = doc.data();
      // Soglia a 600px: se è mobile, 20 immagini in top. Se no, layout desktop.
      const isMobile = window.innerWidth < 600;

      if (isMobile) {
        /**************************************
         * LAYOUT MOBILE
         * => Tutte e 20 in #login-images-top
         * => Nascondiamo left, right, bottom
         **************************************/
        ...
        // Append tutte le 20 immagini in top
        for (let i = 1; i <= 20; i++) {
...
/**
 * Funzione di supporto che crea il <img> e lo mette nel container
 */
